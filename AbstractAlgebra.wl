...
matOrder::usage = "matOrder[matrix a, p] finds the order of an element of a matrix mod p";
...
matOrder[a_,p_]:= FixedPointList[modMat[First@#,a,3]&,MatrixForm[a],SameTest -> (First@# == {{1,0},{0,1}}&)];
